...
public class Orders extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String Burger = ((jComboBox1.getSelectedItem()).toString());
        ...
        String insert = "INSERT INTO ordertable VALUES('" +User+"','" + Password + "','"+Burger +"','"+Size+"','"+Quantity+"','"+Address+"')";
        st.executeUpdate(insert);
        System.out.println("Your Order was Succesfull");
        con.close();
